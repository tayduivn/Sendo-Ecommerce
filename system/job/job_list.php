...
<div style="float:left;width:195px;padding-top:8px">
Danh mục
</div>
...
$sql_pro_vip = "select * from job where job_cat in (".$catallsub."0) and vip=1 $where  order by vip desc limit 5";
...
<div style="float:left;width:510px;padding-top:8px">
<a href="./?home=job&act=views&id=<?php echo $row_pro_vip['id'];?>&cat=<?php echo $row_pro_vip['job_cat'];?>"><?php echo dwebvn($row_pro_vip['name'],15);?></a>
</div>
...
$sql_pro = "select * from job where job_cat in (".$catallsub."0) and vip=0 $where order by id desc limit ".$row*$col*$p.",".$row*$col;
$result = @mysql_query($sql_pro,$con);
$total=CountRecord("job","job_cat in (".$catallsub."0)");
...
<div style="float:left;width:510px;padding-top:8px">
<a href="./tuyen-dung/<?php echo doidau(mb_strtolower($row_pro['name'],"UTF8"));?>-vn-<?php echo $row_pro['id'];?>.html"><?php echo dwebvn($row_pro['name'],15);?></a>
</div>
<div style="float:left;width:165px;padding-top:8px">
