...
$url = explode("&", $uri);
$sql_pro_vip = "select * from avd where vip=1 $where order by vip desc";
...
?>
<div style="width: 100%;padding-top:5px;background-color:<?php echo $color;?>">
<div style="float:left;width:36px;height:35px;background-image: url('<?php echo $bg;?>');">
</div>
<div style="float:left;width:510px;padding-top:8px">
<a href="./rao-vat/<?php echo doidau(mb_strtolower($row_pro_vip['name'],"UTF8"));?>-vn-<?php echo $row_pro_vip['id'];?>.html"><?php echo dwebvn($row_pro_vip['name'],15);?></a>
</div>
<div style="float:left;width:165px;padding-top:8px">
...
$sql_pro = "select * from avd where vip=0 $where order by upvip desc limit ".$row*$col*$p.",".$row*$col;
...
<div style="float:left;width:510px;padding-top:8px">
<a href="./rao-vat/<?php echo doidau(mb_strtolower($row_pro['name'],"UTF8"));?>-vn-<?php echo $row_pro['id'];?>.html"><?php echo dwebvn($row_pro['name'],15);?></a>
</div>
<div style="float:left;width:165px;padding-top:8px">
