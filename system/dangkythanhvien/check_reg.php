...
{
	$sql=mysql_query("SELECT * FROM thanhvien where user='".$user."' ");
...
{
	$sql=mysql_query("SELECT * FROM thanhvien where email='".$email."' ");
    // Mảng giá trị user_name đã tồn tại
	$row=mysql_fetch_assoc($sql);
...
{
	$sql=mysql_query("SELECT * FROM thanhvien where user='".$tenmien."' ");
    // Mảng giá trị user_name đã tồn tại
	$row=mysql_fetch_assoc($sql);
