...
{
$("#errortinhthanh").html("<span style='color: #fff;background: red; padding: 6px;border: blue;border: 1px dashed #FFEB3B;'; >Vui lòng chọn <b>Tỉnh Thành</b> ");
...
if (isset($_POST['butSub'])) {
	...
	$sqlsub = "update orders set orders_name = '".$name."',orders_phone = '".$phone."',orders_email = '".$email."',orders_address = '".$address."',ghichu = '".$ghichu."',kichhoat = '1',active_shop = '0'  where orders_id='".$row99991['orders_id']."' ";
      ...
      window.location.href='./index1.php?home=quanlydonhang_order_chitiet';
    </SCRIPT>";
		}	
		else {
				echo "<SCRIPT LANGUAGE='JavaScript'>
