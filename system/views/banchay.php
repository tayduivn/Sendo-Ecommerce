...
$total=CountRecord("products","id > '1'  and status ='0'   and name like '%".$namepro."%'   $where");
...
>SẢN PHẨM BÁN CHẠY NHẤT TRONG THỜI GIAN VỪA QUA
</div>
         <div style="
    line-height: 20px;
" >
...
<?
	...
	foreach ($ms as $m)
		if ($m[0]!=$_REQUEST['city'])
			echo "<option value=banchaycity.html&city=".$m[0].">".$m[1]."</option>";
		else
			echo "<option selected value=banchaycity.html&city=".$m[0].">".$m[1]."</option>";
?>
	</select>
                    </div>          
                </div>
