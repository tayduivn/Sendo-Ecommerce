...
if (isset($_POST['butSub'])) {
	...
	$sqlsub = "update orders set orders_name = '".$name."',orders_phone = '".$phone."',orders_email = '".$email."',orders_address = '".$address."',ghichu = '".$ghichu."',kichhoat = '1'  where orders_id='".$row99991['orders_id']."' ";
		if (mysql_query($sqlsub)) 
			 {
...
<div id="content_center">
 <div class="d-step" style=" float: left; width: 100%; height: 52px; border-bottom: 1px solid #ddd; margin-bottom: 18px; margin-top: 4px; ">
           <center> <b style=" font-size: 20px; color: red; ">CHÚC MỪNG BẠN ĐÃ MUA HÀNG THÀNH CÔNG</b></center>
		    <center> <b style=" font-size: 18px; color: #673AB7; ">THÔNG TIN CHI TIẾT ĐƠN HÀNG SỐ: <?php echo $p;?></b></center>
        </div>
