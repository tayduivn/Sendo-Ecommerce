...
if($_SESSION['mem']==$truy_xuat_in['user_mem'] && $_REQUEST['p'] == $truy_xuat_in['orders_id'] &&  $truy_xuat_in['active']=='2' &&  $truy_xuat_in['chuyentien']=='0' ){?>
...
<?php if($xemlaikhieunai_in['hoantat_khieunai']=='0')
{?>
<button  name="huykhieunai" type="submit"   style=" color: #fff; font-size: 14px; line-height: 32px; height: 32px; padding: 0 82px; background-color: #7b7979; border: none; text-transform: uppercase; border-radius: 2px; font-weight: bold; white-space: nowrap;  " title="Mua hàng" type="button">Hủy khiếu nại</button>
...
<?}
  ...
  <button name="guikhieunai" type="submit"  style=" color: #fff; font-size: 14px; line-height: 32px; height: 32px; padding: 0 82px; background-color: #e5101d; border: none; text-transform: uppercase; border-radius: 2px; font-weight: bold; white-space: nowrap;  " title="Mua hàng" type="button">Gửi khiếu nại</button>
