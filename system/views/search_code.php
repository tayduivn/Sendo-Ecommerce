...
$sql_pro = "select * from products where id > '1'  and status ='0'   $where and name like '%".$namepro."%' or code like '%".$namepro."%' or user like '%".$namepro."%' or tukhoaseo like '%".$namepro."%' or tieudeseo like '%".$namepro."%'  or motaseo like '%".$namepro."%' or price_special like '%".$namepro."%'  or date like '%".$namepro."%' or company like '%".$namepro."%' or phone like '%".$namepro."%' or address like '%".$namepro."%' order by ".$by." ".$order." limit ".$row*$col*$p.",".$row*$col;
$result = @mysql_query($sql_pro,$con);
$sql_pro1 = "select * from products where id > '1' and status ='0'   $where and name like '%".$namepro."%' or code like '%".$namepro."%' or user like '%".$namepro."%' or tukhoaseo like '%".$namepro."%' or tieudeseo like '%".$namepro."%'  or motaseo like '%".$namepro."%' or price_special like '%".$namepro."%'  or date like '%".$namepro."%' or company like '%".$namepro."%' or phone like '%".$namepro."%' or address like '%".$namepro."%'  order by ".$by." ".$order." limit ".$row*$col*$p.",".$row*$col;
$result1 = @mysql_query($sql_pro1,$con);
$total=CountRecord("products","id > '1'  and status ='0'   and name like '%".$namepro."%' or code like '%".$namepro."%' or user like '%".$namepro."%' or tukhoaseo like '%".$namepro."%' or tieudeseo like '%".$namepro."%'  or motaseo like '%".$namepro."%' or price_special like '%".$namepro."%'  or date like '%".$namepro."%' or company like '%".$namepro."%' or phone like '%".$namepro."%' or address like '%".$namepro."%' $where");
...
<a style="
    color: white;
" href="?keywords=<?echo $_REQUEST['keywords']?>&type=1&act=search&home=search&search=">Mới cập nhật</a>
</div>
<div style="float:left;line-height:240%;padding-left:10px;padding-right:10px;height:30px;background: #3c8e36;">
<a style="
    color: white;
" href="?keywords=<?echo $_REQUEST['keywords']?>&type=1&act=search&home=search&search=&by=price_special&order=asc">Giá rẻ nhất</a>
</div>
<div style="float:left;line-height:240%;padding-left:10px;padding-right:10px;height:30px;background: #2d3392;">
<a style="
    color: white;
" href="?keywords=<?echo $_REQUEST['keywords']?>&type=1&act=search&home=search&search=&by=price_special&order=desc">Giá cao nhất</a>
</div>
...
<?
	...
	foreach ($ms as $m)
		if ($m[0]!=$_REQUEST['city'])
			echo "<option value=?keywords=".$_REQUEST['keywords']."&type=1&act=search&home=search&search&city=".$m[0].">".$m[1]."</option>";
		else
			echo "<option selected value=?keywords=".$_REQUEST['keywords']."&type=1&act=search&home=search&search&city=".$m[0].">".$m[1]."</option>";
?>
	</select>
                    </div>          
                </div>
...
$param="";
if ($p>1) echo '<a class="buton_timkiem" title="&#272;&#7847;u tiên" href="'.$uri.'&p=0">Đầu tiên</a>  ';
if ($p>0) echo '<a class="buton_timkiem" title="&#272;&#7847;u tiên" href="'.$uri.'&p='.($p-1).'">Trang trước</a>';
$from=($p-8>0?$p-1:0);
...
if ($p<$i-1) echo '<a class="buton_timkiem" title="Ti&#7871;p theo" href="'.$uri.'&p='.($p+1).'">Trang tiếp</a>';
if ($p<$pages-1) echo '<a class="buton_timkiem" title="Cu&#7889;i cùng" href="'.$uri.'&p='.($pages-1).'">Cuối cùng</a>'; 
echo '</td></tr></table>';
?>
