...
$mail->Password   = "Key112233Mou";        // SMTP account password

$mail->SetFrom('support@shopcantho.vn', 'ShopCanTho.Vn');

$mail->AddReplyTo("support@shopcantho.vn","ShopCanTho.Vn");
?>
...
if (isset($_POST['butSub'])) {
	...
	if ($err=='')
	{
		$sql = "select * from thanhvien where email='".$email."' limit 1";
