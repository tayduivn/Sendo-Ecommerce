...
<title>Hình ảnh của - Sony Xperia E1 D2005 | Sony Xperia E1 D2005 Black | Mobile</title>
...
<div id="detail_overlay" class="filter_ov">				
	<div class="product_picture_slide">
		<div id="galleryTouch">
			<ul id="imgs" class="list_image">
										<li class="slide_item">
							<div class="img_box">
								<img id="sl_0" alt="Ảnh số  1 - Sony Xperia E1 D2005 Black" title="Sony Xperia E1 D2005 Black" src="/themes/v1/css/loading.gif" data-src="<?echo str_replace("_thumbnail","",$row_pro['image']);?>" />
							</div>
						</li>
											<li class="slide_item">
							<div class="img_box">
								<img id="sl_1" alt="Ảnh số  2 - Sony Xperia E1 D2005 Black" title="Sony Xperia E1 D2005 Black" src="/themes/v1/css/loading.gif" data-src="<?echo $row_pro['image_large'];?>" />
							</div>
						</li>
											<li class="slide_item">
							<div class="img_box">
								<img id="sl_2" alt="Ảnh số  3 - Sony Xperia E1 D2005 Black" title="Sony Xperia E1 D2005 Black" src="/themes/v1/css/loading.gif" data-src="<?echo $row_pro['img2'];?>" />
							</div>
						</li>
								</ul>
		</div>
		...
		<div class="slide_bottom">
			<span id="sl_current">1</span> / <span id="total_img"> 3 ảnh</span>
	...
	<div class="break_module"></div>
		...
		$(document).ready(function(){
			...
			detail_slide('#galleryTouch','#imgs','#sl_',3,1,0);
		})
	</script>
