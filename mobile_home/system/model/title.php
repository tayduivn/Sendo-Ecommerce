...
switch ($_REQUEST['home'])
{
	...
	case "viewdoc" :
		...
		break;
	case "adv" :
		include("mobile_home/system/model/title_adv.php");
		break;
	case "store" :
		$title=$titles['website'];
		break;
	case "job" :
		include("mobile_home/system/model/title_job.php");
		break;
	case "company" :
		include("class/include/title_company.php");
		break;
	case "news" :
		include("mobile_home/system/model/title_new.php");
		break;
	case "help" :
		include("mobile_home/system/model/title_help.php");
		break;
	case "edoc" :
		$cat=0;
