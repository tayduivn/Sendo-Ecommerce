...
<table border="1" cellpadding="2" style="border-collapse: collapse" bordercolor="#C9C9C9" width="100%" id="AutoNumber1">
  <tr>
    ...
    <td align="center" nowrap class="title"><a class="title" href="<? echo GetLinkSort(2); ?>"><b>Tên câu h&#7887;i</b></a></td>
    <td align="center" nowrap class="title"><a class="title" href="<? echo GetLinkSort(3); ?>"><b>H&#7885; tên</b></a></td>
    <td align="center" nowrap class="title"><a class="title" ><b>Gi&#7899;i tính</b></a></td>
    <td align="center" nowrap class="title"><a class="title" href="<? echo GetLinkSort(5); ?>"><b>Email</b></a></td>    
    <td align="center" nowrap class="title"><a class="title" href="<? echo GetLinkSort(6); ?>"><b>Không hi&#7879;n</b></a></td>
    <td align="center" nowrap class="title"><a class="title" href="<? echo GetLinkSort(7); ?>"><b>Th&#7913; t&#7921;</b></a></td>
    <td align="center" nowrap class="title"><a class="title" href="<? echo GetLinkSort(8); ?>"><b>Ngày</b></a></td>
  ...
  <tr>
    ...
    <td align="center" bgcolor="<? echo $color; ?>" class="smallfont">
    <a onclick="return confirm('B&#7841;n có ch&#7855;c ch&#7855;n mu&#7889;n xoá ?');" href="./?act=<? echo $_REQUEST['act']; ?>&status=<? echo $_REQUEST['status']; ?>&action=del&cat=<? echo $_REQUEST['cat']; ?>&id=<? echo $row['faq_id']; ?>">Xóa</a></td>
