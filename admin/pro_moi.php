...
<table height="28" cellSpacing="0" cellPadding="0" width="100%" border="0">
      <tr align=center>
        <td class="title" width="100%">Danh sách &#7843;n ph&#7849;m mới
	</td>
      </tr>
    </table>
<?
...
<td align="center" nowrap class="title"><b>Ngày đăng</b></td>
  ...
  <?php
           	$sql="select * from products where $where and cat_mem!=45 and cat_mem!=46 and new=0 order by id limit ".($p*$MAXPAGE).",".$MAXPAGE;
        	$result=mysql_query($sql,$con);
        	$i=0;
