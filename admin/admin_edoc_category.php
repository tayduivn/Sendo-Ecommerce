<table height="28" cellSpacing="0" cellPadding="0" width="100%" border="0">
      <tr align=center>
        ...
        Danh th&#432; vi&#7879;n : <b> <a href="./?act=edoc_category_m"><font color="#FFFFFF">Nh&#7853;p 
...
{	global $con;
	...
	$pageindex=taotrang("select count(*) from doc_categories where $where and doc_categories_parentid>0","./?act=edoc_category"."&page=",$MAXPAGE,$page);
?>
...
?>
	...
	<input type="button" value="Chuy&#7875;n" class="button" onclick="window.location='./?act=edoc_category&cat='+ddCat.value">
	</td>
</tr>
...
<table border="1" cellpadding="2" style="border-collapse: collapse" bordercolor="#C9C9C9" width="100%" id="AutoNumber1">
  ...
  <?
            	$sql="select *,DATE_FORMAT(date_added,'%d/%m/%Y %h:%m') as dateformat from doc_categories where $where and doc_categories_parentid>0  order by doc_categories_id limit ".($p*$MAXPAGE).",".$MAXPAGE;
            	$result=mysql_query($sql,$con);
            	$i=0;
