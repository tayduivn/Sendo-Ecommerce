...
<table border="1" cellpadding="2" style="border-collapse: collapse" bordercolor="#C9C9C9" width="100%" id="AutoNumber1">
  ...
  <tr>
    ...
    <a href="./?act=pro_saleoff_m&id=<? echo $row['pro_id']; ?>&page=<? echo $page?>">S&#7917;a</a></td>
    </td>
    <td width="20" bgcolor="<? echo $color; ?>" class="smallfont">
    <a onclick="return confirm('B&#7841;n có ch&#7855;c ch&#7855;n mu&#7889;n xoá ?');" href="./?act=pro_saleoff&action=del&page=<? echo $_REQUEST['page']; ?>&id=<? echo $row['pro_id']; ?>">Xoá</a></td>
