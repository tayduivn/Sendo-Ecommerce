...
<center style="
    font-size: 16px;
    color: #ff0000;"><i class="fa fa-fw fa-bullhorn"></i><i class="fa fa-fw fa-bullhorn"></i><i class="fa fa-fw fa-bullhorn"></i><b style="
    font-size: 23px;
    color: #ff0000;">HÀNG MỚI VỀ</b><i class="fa fa-fw fa-bullhorn"></i><i class="fa fa-fw fa-bullhorn"></i><i class="fa fa-fw fa-bullhorn"></i></center>
</div>
...
$hang=8;
$cot=8;
$sql2=mysql_query("SELECT * FROM products where user='".$user."'   order by id DESC limit 12");?>
<? for($i=1;$i<=$cot;$i++)
 {?>
