...
$hang=8;
$cot=8;
$sql2=mysql_query("SELECT * FROM products where user='".$user."' and selling=1 order by id asc limit 24");?>
<? for($i=1;$i<=$cot;$i++)
 {?>
...
<?
	...
	<a href="http://localhost/<? echo str_replace($marTViet,$marKoDau,$row2['name']); ?>-pro-<?php echo $row2['id'];?>.html"> <? echo dwebvn($row2['name'],8);?></a>
	</li>
