jQuery(document).ready(function(){
		...
		$(".carousel-posts").jCarouselLite({
			...
			speed: 200
				...
				// Carousel
		$(".carousel-posts_banchay").jCarouselLite({
			btnNext: ".pc-next_banchay",
			btnPrev: ".pc-prev_banchay",
			visible: 4,
			scroll: 4,
			speed: 200
		});
				// Carousel
		$(".carousel-posts_moinhat").jCarouselLite({
			btnNext: ".pc-next_moinhat",
			btnPrev: ".pc-prev_moinhat",
			visible: 4,
			scroll: 4,
			speed: 200
		});
